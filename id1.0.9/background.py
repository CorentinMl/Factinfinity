...
def CalcPositions():
	...
	for x in range (background_width):
		for y in range (background_height):
			background_screen.blit(background_texture[World.GetElement((x+player_coords[0]-background_center_x,y+player_coords[1]-background_center_y))], (x*background_texture[0].get_width(),y*background_texture[0].get_height()))
