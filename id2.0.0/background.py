...
class BackgroundElement(pygame.sprite.Sprite):
	...
	background_texture = [pygame.image.load("../../res/textures/background/erreur.png"),pygame.image.load("../../res/textures/background/dirt-1.png"),pygame.image.load("../../res/textures/background/grass-1.png")]

	def __init__(self, element_id, (pos_x, pos_y)):
		super().__init__()
		self.element_id = element_id
		self.rect = background_texture[self.element_id].get_rect()
		self.rect.x = pos_x
		self.rect.y = pos_y
