...
while is_game_running:
	...
	ShowMessage(("Fps:"+str(past_fps)+" ,TPS:"+str(past_tps)), 20, "arial", "yellow", 80, 20)
	ShowMessage(("x="+str(Player.player_x_coord)+" ,y="+str(Player.player_y_coord)), 20, "arial", "yellow", 80, 40)
	pygame.display.flip()
	current_fps+=1
